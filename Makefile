...
start-goal:
	@docker exec ros2coppelia bash -c '/ros_entrypoint.sh ros2 topic pub /goal_pose geometry_msgs/msg/PoseStamped "{header:{stamp: {sec: 0, nanosec: 0}, frame_id: "map"}, pose: {position: {x: -2.05, y: -1.75, z: 0.002}, orientation: {x: 0.0, y: 0.0, z: 1.0}}}"'